    ...
    public partial class CreateTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_DoctorDays_DayId",
                        column: x => x.DayId,
                        principalTable: "DoctorDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_DoctorTime_TimeId",
                        column: x => x.TimeId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11c4e375-3cb0-47d0-9d38-ffca20b152f1", null, "Patient", "PATIENT" },
                    { "9c410860-1ca4-4ca3-86cb-ecb9bf3c851c", null, "Doctor", "DOCTOR" },
                    { "c3391077-3ae9-4733-98db-2e1db0b5bf66", null, "Admin", "ADMIN" }
                });
